<template>
  <section class="return-bar" :class="{ inactive: !modelValue, compact }">
...
.return-bar.compact{display:flex;flex-direction:column;align-items:stretch;gap:.65rem;min-height:0;border:1px solid #bce9db;border-radius:.65rem;padding:.7rem}.compact .return-toggle{width:100%}.compact .route-icon{width:2rem;height:2rem;border-radius:.6rem}.compact .decision{flex:1}.compact .return-route{border-top:1px solid #cfe8e1;border-left:0;padding-top:.65rem;padding-left:0}.compact .route-points{display:grid;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr)}.compact .route-points strong:last-child{text-align:right}.compact .route-time{flex-wrap:wrap;white-space:normal;line-height:1.35}.compact .assigned-resources{grid-template-columns:1fr}.compact .assigned-resources>span{padding:.42rem .55rem}.compact.inactive{border-color:#e2e8f0}
