      ...
      <div class="flex items-center justify-between px-4 py-3">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="w-10 h-10 rounded-full border-2 border-white/20 overflow-hidden bg-white/10 shrink-0 shadow-sm flex items-center justify-center">
             ...
             <span v-else class="material-symbols-outlined text-white opacity-80">account_circle</span>
          </div>

          <!-- Logout Btn -->
          <button @click="handleLogout" class="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 active:bg-white/30 transition-colors shrink-0">
